...
if (document.getElementById('notepad-link') &&
    document.getElementById('content__items-notepad')) {
    var old = document.getElementById('notepad-link');
    const notepad_link = document.getElementById('notepad-link');
    const notepad_item = document.getElementById('content__items-notepad');
    notepad_link.addEventListener('click', () => addOrder(notepad_item));
}

if (document.getElementById('sublime-link') &&
    document.getElementById('content__items-sublime')) {
    const sublime_link = document.getElementById('sublime-link');
    const sublime_item = document.getElementById('content__items-sublime');
    sublime_link.addEventListener('click', () => addOrder(sublime_item));
}

if (document.getElementById('prepros-link') &&
    document.getElementById('content__items-prepros')) {
    const prepros_link = document.getElementById('prepros-link');
    const prepros_item = document.getElementById('content__items-prepros');
    prepros_link.addEventListener('click', () => addOrder(prepros_item));
}
