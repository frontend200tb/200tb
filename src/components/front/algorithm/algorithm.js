...
Функция showAlgorithm показывает страницу algorithm
****************** */
import './element-algorithm';
import pageLink from './pages/pages';

// 1. Создаем массив asideThemes с темами
const asideThemes = ['Algorithm', 'Сложность', 'Сортировка', 'Поиск', 'Тренировки 1.0', 'Тренировки 2.0', 'Тренировки 3.0', 'Тренировки 4.0', 'Тренировки 5.0', 'Яндекс.Контест 2019'];
