...
const dataArray = [
  ...
  // Base
  dataBooksBase, dataBooksAlgorithm, dataBooksComp, dataBooksOs, dataBooksBios, dataBooksLinux, dataBooksUnix, dataBooksFreebsd, dataBooksNet, dataBooksSysadmin, dataBooksOop, dataBooksInformatika,
  // Framework
