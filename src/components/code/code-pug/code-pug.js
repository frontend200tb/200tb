/** *******************
Скрипт из файла code-pug.js
Функция showCodePug показывает страницу code-pug
******************** */
import './element-code-pug';
import pageLink from './pages/pages';

// 1. Создаем массив asideThemes с темами
const asideThemes = ['Pug'];
...
export default function showCodePug() {
