/** *******************
Скрипт из файла code-markdown.js
Функция showCodeMarkdown показывает страницу code-markdown
******************** */
import './element-code-markdown';
import pageLink from './pages/pages';

// 1. Создаем массив asideThemes с темами
const asideThemes = ['Markdown'];
...
export default function showCodeMarkdown() {
