/** *******************
Скрипт из файла code-sass.js
Функция showCodeSass показывает страницу code-sass
******************** */
import './element-code-sass';
import pageLink from './pages/pages';

// 1. Создаем массив asideThemes с темами
const asideThemes = ['SASS'];
...
export default function showCodeSass() {
