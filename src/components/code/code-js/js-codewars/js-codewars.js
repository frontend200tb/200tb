/** *******************
Скрипт из файла js-codewars.js
Функция showJsCodewars показывает страницу js-codewars
******************** */
import './element-js-codewars';
...
for (const theme of asideThemes) {
  ...
  function createId(str) {
    ...
    return `codewars-${str.replace(/[^a-z0-9]/gi, '').toLowerCase()}`;
  }
...
export default function showJsCodewars() {
