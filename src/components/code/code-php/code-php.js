/** *******************
Скрипт из файла code-php.js
Функция showCodePhp показывает страницу code-php
******************** */
import './element-code-php';
import pageLink from './pages/pages';

// 1. Создаем массив asideThemes с темами
const asideThemes = ['Php'];
...
export default function showCodePhp() {
