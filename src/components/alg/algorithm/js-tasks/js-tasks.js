/** *******************
Скрипт из файла js-tasks.js
Функция showJsTasks показывает страницу js-tasks
******************** */
import './element-js-tasks';
import pageLink from './pages/pages';

// 1. Создаем массив asideThemes с темами
const asideThemes = ['Задачи', 'Задачи 2', 'Деревья', 'ШАД'];
...
export default function showJsTasks() {
